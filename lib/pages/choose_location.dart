...
class _ChooseLocationState extends State<ChooseLocation> {
  List<WorldTime> locations = [
    ...
    WorldTime(link: 'Europe/Athens', location: 'Athens', flag: 'greece.png'),
    WorldTime(link: 'Africa/Cairo', location: 'Cairo', flag: 'egypt.png'),
    ...
    WorldTime(link: 'Asia/Seoul', location: 'Seoul', flag: 'south_korea.png'),
